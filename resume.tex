...
% ----------------------------------------------------------
\usepackage[top=0.50in, bottom=0.45in, left=0.70in,right=0.70in,  nohead,includefoot]{geometry}
\usepackage{hyperref}
\usepackage{fancyhdr}
\usepackage{titlesec}
\usepackage{titling}
...
\newcommand{\CVEmail}{dgrusak@trinity.edu}
\newcommand{\CVPhone}{(713) 657-0096}
\newcommand{\CVNote}{\footnotesize{Compiled on {\today}, available at \href{\CVWebpageCV}{\CVWebpageCV}. \end{footnotesize}}
\newcommand{\CVWebpage}{github.dakotagrusak.io}
\newcommand{\CVWebpageCV}{github.com/dakotawgrusak/cv.git}

\newcommand{\TrinityTitle}{\href{https://new.trinity.edu/academics/departments/engineering-science}{\textbf{Trinity University}}, San Antonio, TX}
% \newcommand{\TrinityTitle}{\href{https://new.trinity.edu/academics/departments/computer-science}{\textbf{Trinity University}}, San Antonio, TX}
...
\renewcommand{\sffamily}{\rmfamily} % Sans-serif font: Changed to "Tinos".
\renewcommand{\ttfamily}{\rmfamily}% Typewriter (monospace) font: Changed to "Tinos".

\renewcommand{\scshape}{\rmfamily}% Small caps font: Changed to "Tinos".
